...
DoViP is a workflow designed to integrate the results from several virus predictors: geNomad, DeepVirFinder, VirSorter2, VIBRANT and ViralVerify. Its main features are:
  ...
  * Selecting final non-integrated virus contigs and integrated virus regions based on i) the number of predictors detecting them (more precisely, on the predictor coverage along the viral sequence); and ii) their completeness, as determined by CheckV. 
...
![DoViPv1.0.0 workflow scheme](images/DoViPv1.0_workflow_ms_details.png)  
